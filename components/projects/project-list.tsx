...
import { ProjectCard, ProjectCategory, ProjectCardProps } from "./project-card"
...
export const projects: ProjectCardProps[] = [
  ...
  },
  {
    ...
    description: "Blockchain explorer for the Verus network showing transactions, blocks, and network statistics in real-time.",
    url: "https://insight.verus.io",
    category: "Dashboard" as ProjectCategory
  },
  {
    name: "Verus Wisdom",
    description: "Dashboard for network statistics, mining difficulty, staking rewards, market data for VRSC, and much more",
    url: "https://www.veruswisdom.com",
    category: "Dashboard" as ProjectCategory
  },
  {
    name: "VerusIDs.com",
    description: "Overview of registered VerusIDs, VerusIDs on offer and tool to create API command for registrations.",
    url: "https://www.verusids.com",
    category: "Dashboard" as ProjectCategory
  },
  {
    name: "Verus-Ethereum Bridge",
    description: "Cross-chain bridge for moving currencies and tokens between Verus and Ethereum. Non-custodial and trustless.",
    url: "https://eth.verusbridge.io",
    category: "Technology" as ProjectCategory
  },
  {
    name: "VaultAlert",
    description: "Easy tool to check the status of Verus Vault on your VerusID.",
  ...
  },
  {
    ...
    description: "Large dashboard with all information on basket currencies, TVL, volume and much more.",
    url: "https://cryptodashboard.faldt.net",
    category: "Dashboard" as ProjectCategory
  },
  {
    name: "VerusMarkets",
    description: "Information about decentralized on-chain currency pricing and volume, liquidity pool reserves, TVL and more",
