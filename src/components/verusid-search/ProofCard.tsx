      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-lg w-6 text-center">
            ...
            {!title.toLowerCase().match(/linkedin|reddit|twitter|github|verus|btc|eth/) && '🔗'}
          </div>
          
          <div className="flex-1">
            <div className="font-medium">{title}</div>
            {address && <div className="text-xs text-gray-500 dark:text-gray-400 truncate max-w-xs">{address}</div>}
          </div>
        </div>
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-700">
              ...
              {signatures.sig1Status && (
                <div className="flex items-center">
                  <div className="flex items-center gap-2 w-full">
                    ...
                    <span className="font-medium text-gray-800 dark:text-gray-200">Signature 1:</span>
                    <div className="ml-2">
                      {signatures.sig1Status === 'pass' ? (
                        <span className="inline-flex items-center rounded-full bg-green-100 dark:bg-green-800/30 px-2.5 py-0.5 text-sm font-medium text-green-800 dark:text-green-400">
                        ...
                        <span className="inline-flex items-center rounded-full bg-red-100 dark:bg-red-800/30 px-2.5 py-0.5 text-sm font-medium text-red-800 dark:text-red-400">
                          <svg className="w-3.5 h-3.5 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
              ...
              {signatures.sig2Status && (
                <div className="flex items-center">
                  <div className="flex items-center gap-2 w-full">
                    ...
                    <span className="font-medium text-gray-800 dark:text-gray-200">Signature 2:</span>
                    <div className="ml-2">
          ...
          {proofLink && (
            <a 
              ...
              className="mt-3 inline-flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 text-sm"
            >
